...
class TestReasoningBank(unittest.TestCase):
    ...
    def test_add_experience_success(self):
        ...
        # Assert that the embedding model was called to embed the content
        self.mock_embedding_model.encode.assert_any_call(["c1"])
        ...
        self.assertEqual(args[0][0]["metadata"]["title"], "t1")
        self.assertEqual(args[0][0]["embedding"], [0.1, 0.2])
