...
from reasoningbank.memory.chroma import ChromaMemoryBackend
...
class TestJSONMemoryBackend(unittest.TestCase):
    ...
    def test_add_and_query(self):
        items = [
            {
                "embedding": [0.1, 0.2],
                "metadata": {"title": "t1", "description": "d1", "content": "c1"},
                "document": "c1",
            },
            {
                "embedding": [0.3, 0.4],
                "metadata": {"title": "t2", "description": "d2", "content": "c2"},
                "document": "c2",
            },
        ]
...
class TestChromaMemoryBackend(unittest.TestCase):
    ...
    def test_add_and_query(self):
        ...
        # The query should return the item with the embedding closest to the
        # query embedding. In this case, [0.6, 0.7, 0.8] is closer to
        # [0.7, 0.8, 0.9] than to [0.1, 0.2, 0.3].
